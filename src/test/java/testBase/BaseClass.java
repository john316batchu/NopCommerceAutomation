...
public Properties prop;
	...
	public void setup(String br, String os) throws IOException {
		...
		//Launching browser based on execution environment
		if(prop.getProperty("execute_env").equalsIgnoreCase("remote")) {
		...
		}else if(prop.getProperty("execute_env").equalsIgnoreCase("local")) {
